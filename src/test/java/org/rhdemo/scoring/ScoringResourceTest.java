...
public class ScoringResourceTest {
    ...
    public void testEndpoint() throws Exception {
        ...
        is = given().when().contentType("application/json").body(json).post("/game/score")
                ...
                .body("currentRound.guessResult.submittedGuess[0]", equalTo(1))
                .body("currentRound.guessResult.submittedGuess[1]", equalTo("."))
                .body("currentRound.guessResult.submittedGuess[2]", equalTo(""))
                .body("currentRound.guessResult.submittedGuess[3]", equalTo(""))
                .body("currentRound.guessResult.answer[0]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[1]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[2]", equalTo("PENDING"))
                .body("currentRound.guessResult.answer[3]", equalTo("PENDING"))
                .body("currentRound.choices[0]", equalTo(9))
        ...
        is = given().when().contentType("application/json").body(json).post("/game/score")
                ...
                .body("currentRound.guessResult.submittedGuess[0]", equalTo(1))
                .body("currentRound.guessResult.submittedGuess[1]", equalTo("."))
                .body("currentRound.guessResult.submittedGuess[2]", equalTo(9))
                .body("currentRound.guessResult.submittedGuess[3]", equalTo(""))
                .body("currentRound.guessResult.answer[0]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[1]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[2]", equalTo("WRONG"))
                .body("currentRound.guessResult.answer[3]", equalTo("PENDING"))
                .body("currentRound.choices[0]", equalTo(9))
                .body("currentRound.choices[1]", equalTo("correct"))
                .body("currentRound.choices[2]", equalTo(0))
        ...
        is = given().when().contentType("application/json").body(json).post("/game/score")
                ...
                .body("currentRound.guessResult.submittedGuess[0]", equalTo(1))
                .body("currentRound.guessResult.submittedGuess[1]", equalTo("."))
                .body("currentRound.guessResult.submittedGuess[2]", equalTo(0))
                .body("currentRound.guessResult.submittedGuess[3]", equalTo(""))
                .body("currentRound.guessResult.answer[0]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[1]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[2]", equalTo("CORRECT"))
                .body("currentRound.guessResult.answer[3]", equalTo("PENDING"))
                .body("currentRound.choices[0]", equalTo(9))
                .body("currentRound.choices[1]", equalTo("correct"))
                .body("currentRound.choices[2]", equalTo(0))
